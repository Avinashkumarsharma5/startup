...
export default function VendorRegistration({ role, vendorType, setRole, setServiceProviderType, setShowMore }) {
  ...
  const SuccessAnimation = () => (
    ...
    >
      ...
      <p className="text-gray-600">Your registration is under review. We will contact you soon!</p>
    </motion.div>
  );
      ...
      <div className="max-w-4xl mx-auto w-full mt-12 mb-12">
        ...
        <div className="flex justify-between items-center mb-6">
          <button
            ...
            className="p-2 rounded-full bg-white shadow-lg text-gray-700 hover:bg-gray-100 transition"
          >
          ...
          <div className="flex gap-4">
            <button
              ...
              className="p-3 rounded-full bg-white shadow-lg flex items-center gap-2 text-gray-700 text-sm hover:bg-gray-100 transition"
            >
        ...
        <motion.div
          ...
          className="bg-white shadow-2xl rounded-2xl p-6 md:p-10 text-gray-800"
        >
          <h2 className="text-3xl sm:text-4xl font-extrabold text-center text-amber-700 mb-2 font-serif">
            {t.title}
          </h2>
                    ...
                    >
                        ...
                        <div ref={formRefs[0]} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="col-span-1">
                            ...
                            <Field 
                              ...
                              className="w-full border-2 border-gray-300 p-3 rounded-xl focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all shadow-sm" 
                            />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              ...
                              <Field 
                                ...
                                type="number"
                                placeholder="e.g., 5"
                                className="w-full border-2 border-gray-300 p-3 rounded-xl focus:border-amber-500 transition-all shadow-sm" 
                              />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                              ...
                              <div
                                ...
                                className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-amber-400 transition-colors cursor-pointer bg-gray-50 min-h-[180px] flex flex-col justify-center items-center"
                              ...
                              >
                                ...
                                {previewUrls.profilePhoto ? (
                                  ...
                                  <>
                                    ...
                                    <p className="text-sm text-gray-600 font-medium">Click or drag profile photo</p>
                            ...
                            <div>
                              ...
                              >
                                ...
                                <p className="text-sm text-gray-600 font-medium">Click or drag documents/samples</p>
                      ...
                      {step === 3 && (
                        <div ref={formRefs[2]} className="space-y-6">
                          ...
                          <div className="p-4 bg-red-50 rounded-xl border border-red-300 flex items-start gap-3">
                  ...
                  {showPreview && (
                    ...
                    >
                      <motion.div
                        ...
                        exit={{ scale: 0.8, y: 50 }}
                        transition={{ duration: 0.3 }}
                        className="bg-white shadow-2xl rounded-2xl p-6 md:p-8 max-w-lg w-full max-h-[90vh] overflow-y-auto"
