      ...
      <div className="flex gap-2 overflow-x-auto">
        {[
          ...
          <button
            ...
            className={`py-2 px-4 rounded-xl font-semibold whitespace-nowrap ${activeTab === tab.key ? "bg-[#FFD700] text-[#5C3A21]" : "bg-gray-200 text-gray-700"}`}
          >
            {tab.label}
          </button>
        ))}
        ...
        {activeTab === "posts" && (
          <div className="bg-white p-4 rounded-2xl shadow-md">
            ...
            <div className="flex gap-3 mt-2">
              ...
              <button className="bg-gray-200 flex items-center gap-2 px-3 py-2 rounded-lg"><Image className="w-4 h-4" /> Upload Banner</button>
              <button className="bg-gray-200 flex items-center gap-2 px-3 py-2 rounded-lg"><Video className="w-4 h-4" /> Upload Reel</button>
            </div>
